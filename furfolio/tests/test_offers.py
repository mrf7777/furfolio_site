...
class EmailOnOfferCreateTestCase(TestCase):
    def setUp(self) -> None:
        self.creator = utils.make_user("creator", role=models.User.ROLE_CREATOR, email="creator@test.com")
        self.buyer1 = utils.make_user("buyer1", role=models.User.ROLE_BUYER, email="buyer1@test.com")
        self.buyer2 = utils.make_user("buyer2", role=models.User.ROLE_BUYER, email="buyer2@test.com")
