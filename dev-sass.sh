...
BOOTSTRAP_JS_TARGET_FILE="${BOOTSTRAP_JS_TARGET_DIRECTORY}/bootstrap.min.js"
BOOTSTRAP_JS_TARGET_MAP_FILE="${BOOTSTRAP_JS_TARGET_DIRECTORY}/bootstrap.min.js.map"
...
cp $BOOTSTRAP_SOURCE_DIR/dist/js/bootstrap.min.js $BOOTSTRAP_JS_TARGET_FILE
cp $BOOTSTRAP_SOURCE_DIR/dist/js/bootstrap.min.js.map $BOOTSTRAP_JS_TARGET_MAP_FILE
